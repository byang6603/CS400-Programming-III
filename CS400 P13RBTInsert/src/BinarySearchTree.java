...
public class BinarySearchTree<T extends Comparable<T>> implements SortedCollectionInterface<T> {
    ...
    protected void rotate(Node<T> child, Node<T> parent) throws IllegalArgumentException {
        ...
        if(parent.down[1] != null && parent.down[1].equals(child)) {
            //checks to see if the parent's right child is equal to the node provided in the parameter
            //performs a left rotation
            if(!(parent.equals(root))) {//checks if parent is root
                if(parent.isRightChild()) {//parent is a right child
                    if(child.down[0] != null) {//if child has a left child
                        parent.up.down[1] = child;
                        child.up = parent.up;
                        //sets the parent of parent to the child node(starting the rotation)
        ...
        }else if(parent.down[0] != null && parent.down[0].equals(child)) {
            //performs a right rotation
            if(!(parent.equals(root))) {//checks if parent is root node
                if(parent.isRightChild()) {//checks if parent is right child
                ...
                }else {//parent must be a left child
                    if(child.down[1] != null) {
                        parent.up.down[0] = child;
                        child.up = parent.up;
            ...
            throw new IllegalArgumentException("No Parent Child Relationship");
        }
    }
    ...
    public static boolean test1() {
        ...
        bst.insert(38);
        bst.insert(59);
        // bst should look like this now:
        //                47
        //               /   \
        //             32     59
        //            /  \   
        //          7     38
        Node parent = bst.findNode(47);
        Node child = bst.findNode(32);
        bst.rotate(child, parent);
        //after rotation bst should look like this:
        //                32
        //               /   \
        //              7    47
        //                  /  \
        //                 38   59
        String actual = bst.toLevelOrderString();
        String expected = "[ 32, 7, 47, 38, 59 ]";
    ...
    public static boolean test2() {
        ...
        //                   /   \
        //                  20     25
        Node parent = bst.findNode(18);
        Node child = bst.findNode(23);
        bst.rotate(child, parent);
    ...
    public static boolean test3() {
        // TODO: Implement this test.
        //testing on a bst that looks like a linked list
        //testing swapping nodes that are not the root node
        ...
        //                   \
        //                    5
        Node parent = bst.findNode(3);
        Node child = bst.findNode(4);
        bst.rotate(child, parent);
    ...
    public static boolean test4() {
      //testing a right rotation on a node that is not the root
        BinarySearchTree bst = new BinarySearchTree();
        bst.insert(50);
        bst.insert(45);
        bst.insert(75);
        ...
        Node parent = bst.findNode(45);
        Node child = bst.findNode(20);
        bst.rotate(child, parent);
        
        //after rotating the bst should look like this:
        //                  50
        //                /    \
        //               20     75
        //              /  \    /  \
        ...
        //               25   48
        String actual = bst.toLevelOrderString();
        String expected = "[ 50, 20, 75, 7, 45, 62, 100, 25, 48 ]";
        if(actual.equals(expected)) {
            return true;
        }
        return false;
    ...
    public static boolean test5() {
        ...
        Node parent = bst.findNode(75);
        Node child = bst.findNode(80);
        bst.rotate(child, parent);
        ...
        String actual = bst.toLevelOrderString();
        String expected = "[ 50, 30, 80, 13, 75, 100, 60, 76, 56, 71 ]";
        if(actual.equals(expected)) {
            return true;
        }
        return false;
